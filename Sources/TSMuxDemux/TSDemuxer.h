...
/// Elementary stream PIDs to process. nil means no whitelist: all ES PIDs are
/// processed. An empty set blocks all ES PIDs. PSI PIDs (PAT/PMT/etc) are
/// always processed regardless of this setting.
@property(nonatomic, copy, nullable) NSSet<NSNumber*> *esPidWhitelist;
